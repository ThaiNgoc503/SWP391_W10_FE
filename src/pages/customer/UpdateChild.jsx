...
const UpdateChild = () => {
  const [date, setDate] = React.useState("2024/05/07");
      ...
      <div className="flex h-screen justify-center bg-gray-50">
        <div className="mt-[8%] h-fit w-1/2 rounded-2xl bg-white shadow-xl">
          <div className="mx-8 my-5">
            <div className="my-3 text-xl font-semibold"> Chỉnh sửa thông tin của trẻ</div>
            <div className="mb-10">Điền thông tin chi tiết của trẻ</div>
            <div>Họ và tên của trẻ</div>
            <Input className="" variant="outlined" label="" value={"Nguyen Thi A"} />
            <div className="mt-10">
              <div>Năm sinh của trẻ</div>
            ...
            <div>
              ...
              <div className="flex gap-10">
                <Radio name="type" label="Nam" checked/>
